...
/** 
	...
	Simulates a data source with a particular channel count
	and sample rate

*/
class SimulatedSource : public Thread
{
public:
    /** Constructor */
    SimulatedSource (String name, int channels, float sampleRate, SimulatedSourceType type);
